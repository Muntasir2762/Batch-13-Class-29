...
// let human = {name: 'Bablu', age: 20, balance: 300, address: 'Dhaka', hobby: 'Singing'};

// for(let key in human){
//     console.log(human[key]); //human[name] //human[age] //human[balance]
// }

let twoDimensionalArray = [
    ['Rahim', 'Karim', 'Bablu', 'Abdul Jobbar'],
    ['Rubel', 'Shahin', 'Arif', 'Seyam'],
    ['Utpol', 'Manik', 'Maruf', 'Mou'],
 ]
